...
\renewcommand{\thefootnote}{{\color{customColor}\Fontauri\normalsize\arabic{footnote}}}
\let\oldfootnote\footnote
    \renewcommand{\footnote}[1]{\oldfootnote{\color{customColor}\Fontauri\normalsize#1}}
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{border2-3.jpeg}}
